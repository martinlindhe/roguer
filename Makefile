...
tiles:
	...
	go run cli/tileslicer/tileslicer.go resources/assets/tilesets/oddball/ground.png     resources/assets/tilesets/oddball/ground 8 12
...
jointiles:
	...
	go run cli/tilejoiner/tilejoiner.go resources/assets/tilesets/oddball/ground/8x4  public/img/tileset/oddball/ground1.png 8; imgcat public/img/tileset/oddball/ground1.png
	go run cli/tilejoiner/tilejoiner.go resources/assets/tilesets/oddball/ground/8x12 public/img/tileset/oddball/ground2.png 8; imgcat public/img/tileset/oddball/ground2.png
