...
GameState.prototype.updateShadowTexture = function()
{
    ...
    var gradient = this.shadowTexture.context.createRadialGradient(
        playerGroup.x, playerGroup.y, this.LIGHT_RADIUS * 0.75,
        playerGroup.x, playerGroup.y, this.LIGHT_RADIUS
    );
    ...
    this.shadowTexture.context.arc(playerGroup.x, playerGroup.y,
